...
import 'package:greylux_mobile/ui_components/pullUpCardInvest.dart';
import 'package:shared_preferences/shared_preferences.dart';

class LoadInvest extends StatefulWidget {
  @override
  _LoadInvestState createState() => _LoadInvestState();
}

class _LoadInvestState extends State<LoadInvest> {
  bool loading;
  dynamic dataMap;
  dynamic id;
